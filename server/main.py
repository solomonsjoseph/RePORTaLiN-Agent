...
from server.auth import AuthContext, require_auth, optional_auth, verify_token
from server.config import get_settings
from server.logger import configure_logging, get_logger, set_request_id
...
def create_app() -> FastAPI:
    ...
    fastapi_app = FastAPI(
        ...
        description=(
            "RePORTaLiN Model Context Protocol (MCP) Server\n\n"
            "This server exposes clinical data query tools via the MCP protocol "
            ...
            "## Available Tools\n\n"
            "- `query_database`: Execute validated SQL queries\n"
            "- `search_dictionary`: Search data dictionary\n"
            "- `fetch_metrics`: Retrieve aggregate statistics\n"
